...
<form method="post" action="<?= $_SERVER["PHP_SELF"]; ?>">
    ...
    &nbsp;
    <hr>
    <center><strong>Yang harus ada</strong> (Kosongkan jika tidak ada)</center>
    <br>
    <table><tr>
    <?php 
        require 'main.php';
        ...
        foreach($raw_data as $val){ ?>
            <td>
            <input type="checkbox"  name="<?php echo preg_replace('/\s+/', '', $val['item']) ;?>">
        ...
        <?php 
            ...
            echo "</tr></table>";
        ?>
    <center><input type="submit" name="submit" value="Submit" style="width: 50%"></center>
    <hr>
</form>
